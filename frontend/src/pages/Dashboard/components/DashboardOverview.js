...
import { faChartBar, faDollarSign, faUserFriends, faUser, faClock } from '@fortawesome/free-solid-svg-icons';
...
export default withWidgetData(DashboardOverview, 'overview');