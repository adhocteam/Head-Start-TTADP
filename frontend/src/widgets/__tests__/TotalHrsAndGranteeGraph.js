...
describe('Total Hrs And Grantee Graph Widget', () => {
  it('shows the correct month data', async () => {
    ...
    await expect(nodes[0].childNodes.length).toEqual(4);
    ...
    await expect(nodes[0].childNodes[1].childNodes[3].childNodes.length).toEqual(3);
  ...
  it('shows the correct day data', async () => {
    ...
    // Verify Number of 'Hours of Technical Assistance' Trace Points.
    await expect(nodes[0].childNodes[2].childNodes[3].childNodes.length).toEqual(2);
